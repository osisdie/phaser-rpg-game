...
export const regionNPCs: Record<string, NPCData[]> = {
  ...
  region_hero: [
    ...
    { id: 'npc_hero_elder', name: '王室長老', x: 12, y: 12, spriteColor: 0xffcc00, dialogueId: 'npc_elder_intro', type: 'quest' },
  ...
  region_elf: [
    ...
    { id: 'npc_elf_elder', name: '精靈長老', x: 12, y: 12, spriteColor: 0x44ff44, dialogueId: 'npc_elf_elder', type: 'quest' },
